...
public class VacancyControllerTest {
    ...
    public void whenRequestVacancyByWrongIdThenGetErrorPageWithMessage() {
        ...
        assertThat(view).isEqualTo("errors/404");
        assertThat(actualVacancy).isEqualTo(null);
    }

    @Test
    public void whenRequestUpdateVacancyThenGetPageWithUpdatesVacancy() throws IOException {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        var fileDto = new FileDto(testFile.getOriginalFilename(), testFile.getBytes());
        var vacancyArgumentCaptor = ArgumentCaptor.forClass(Vacancy.class);
        var fileDtoArgumentCaptor = ArgumentCaptor.forClass(FileDto.class);
    ...
    @Test
    public void whenWrongRequestUpdateVacancyThenGetErrorPageWithMessageError() {
        var errorMessage = "Вакансия с указанным идентификатором не найдена";
    ...
    @Test
    public void whenRequestUpdateVacancyWithExceptionThenGetErrorPageWithMessage() {
        var expectedException = new RuntimeException("Failed to write file");
    ...
    public void whenRequestDeleteVacancyThenGetPageVacancies() {
        var view = vacancyController.delete(0);
