...
public class CandidateControllerTest {
    ...
    public void whenRequestCandidateListPageThenGetPageWithCandidates() {
        ...
        var candidate2 = new Candidate(2, "name2", "desc2", now(), 2, 3);
        ...
        assertThat(actualCandidates).isEqualTo(expectedCandidate);
    }
    ...
    @Test
    public void whenPostCandidateWithExceptionThenGetExceptionMessageAndErrorPage() {
    ...
    @Test
    public void whenRequestCandidateByWrongIdThenGetErrorPageWithMessage() {
        var candidate = new Candidate(1, "name1", "desc1", now(), 1, 2);
        ...
        assertThat(view).isEqualTo("errors/404");
        assertThat(actualCandidate).isEqualTo(null);
    }

    @Test
    public void whenRequestUpdateCandidateThenGetPageWithUpdatesCandidate() throws IOException {
        var candidate = new Candidate(1, "name1", "desc1", now(), 1, 2);
        var fileDto = new FileDto(testFile.getOriginalFilename(), testFile.getBytes());
        var candidateArgumentCaptor = ArgumentCaptor.forClass(Candidate.class);
        var fileDtoArgumentCaptor = ArgumentCaptor.forClass(FileDto.class);
    ...
    @Test
    public void whenWrongRequestUpdateCandidateThenGetErrorPageWithErrorMessage() {
        var errorMessage = "Резюме с указанным идентификатором не найдено";
    ...
    @Test
    public void whenRequestUpdateCandidateWithExceptionThenGetErrorPageWithMessage() {
        var expectedException = new RuntimeException("Failed to write file");
    ...
    public void whenRequestDeleteCandidateThenGetPageCandidates() {
        var view = candidateController.delete(0);
